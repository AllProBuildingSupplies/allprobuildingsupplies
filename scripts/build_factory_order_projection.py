...
INBOUND_JSON = ROOT / "data" / "inbound-containers.json"
MARGINS_CSV = ROOT / "costing" / "Competitive_Margin_Sheet.csv"
COST_XLSX = ROOT / "costing" / "Tommur_Cost_Margin_Tracker.xlsx"
CATALOG_CSV = ROOT / "assets" / "products.csv"

OUT_XLSX = ROOT / "costing" / "Factory_Order_3Mo_Container.xlsx"
OUT_CSV = ROOT / "costing" / "Factory_Order_For_Tommur.csv"
