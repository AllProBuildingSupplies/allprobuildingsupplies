...
def write_xlsx(rows):
    ...
    lines = [
        ...
        "",
        "True DDP to the warehouse should also cover entry, DTHC, chassis, and dray to Livingston.",
        "Palconn DDP sitting ~1% under FOB×1.43+ocean (which already excludes those dest fees) means this is",
        "duty+ocean math, not proven door-to-door. Prefer FOB + our forwarder on the first buy.",
        "",
