...
| **`Hailiang_Copper_Brass_RFQ.xlsx`** | RFQ for Hailiang/Ailiang: site copper SKUs + factory item nos + catalog photos |
| `HAILIANG_COPPER_RFQ.md` | How to send the RFQ and the mm↔inch map |
