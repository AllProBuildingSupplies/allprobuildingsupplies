...
| **PEX** | **½ / ¾ / 1" only** | Zhenpeng = PPSU F2159 (REV held). **Palconn 10 Sep** — PEX-B **$0.081 / $0.157 / $0.256**/ft + F1807. **15 Sep DDP** matches our landed within 1% (`palconn/PALCONN_DDP_15SEP.md`); list GM ~41%, rings underwater. PPSU −5%; still keep Zhenpeng. Do not buy Palconn PVC pipe. Memo: `palconn/PALCONN_LEELA_RFQ.md` |
...
| **Broadloom carpet + pad + tackstrip** | Dongsheng **9 Sep FOB** — 800 g **$5.16/m²** lands **~$7.36/SY**; 850 g **$5.44** lands **~$7.70** vs Artisent $5.92. 800 g is also lighter than 25 oz. Need ~**$3.95/m²**. **Pad** $22/roll lands **~$2.21/SY** vs $1.70 — does not beat. **Halex FOB Shanghai in** — SGR-120 **$10.74**/box lands **~$21.11** vs HD **$28.65**. Beats at $10k ocean. No SKU / no PO. Memos: `CARPET_FACTORY_SOURCING.md`, `halex/HALEX_TACKSTRIP.md`. |
